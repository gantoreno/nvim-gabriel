...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi ErrorStrong ctermbg=NONE ctermfg=9 cterm=bold guibg=NONE guifg=#aa6666 gui=bold
    hi WarningStrong ctermbg=NONE ctermfg=11 cterm=bold guibg=NONE guifg=#ccaa66 gui=bold
