...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi WarningMsg ctermbg=NONE ctermfg=11 cterm=NONE guibg=NONE guifg=#ccaa66 gui=NONE
    ...
    hi DiagnosticError ctermbg=NONE ctermfg=9 cterm=NONE guibg=NONE guifg=#aa6666 gui=NONE
    hi DiagnosticWarn ctermbg=NONE ctermfg=11 cterm=NONE guibg=NONE guifg=#ccaa66 gui=NONE
    hi DiagnosticInfo ctermbg=NONE ctermfg=14 cterm=NONE guibg=NONE guifg=#66bbbb gui=NONE
    hi DiagnosticHint ctermbg=NONE ctermfg=8 cterm=NONE guibg=NONE guifg=#999999 gui=NONE
    hi DiagnosticUnderlineError ctermbg=NONE ctermfg=NONE cterm=undercurl guibg=NONE guifg=NONE gui=undercurl guisp=#aa6666
    hi DiagnosticUnderlineWarn ctermbg=NONE ctermfg=NONE cterm=undercurl guibg=NONE guifg=NONE gui=undercurl guisp=#ccaa66
    hi DiagnosticUnderlineInfo ctermbg=NONE ctermfg=NONE cterm=undercurl guibg=NONE guifg=NONE gui=undercurl guisp=#66bbbb
    hi DiagnosticUnderlineHint ctermbg=NONE ctermfg=NONE cterm=undercurl guibg=NONE guifg=NONE gui=undercurl guisp=#999999
    hi DiagnosticVirtualTextError ctermbg=1 ctermfg=9 cterm=NONE guibg=#2e2323 guifg=#aa6666 gui=NONE
    hi DiagnosticVirtualTextWarn ctermbg=3 ctermfg=11 cterm=NONE guibg=#363024 guifg=#ccaa66 gui=NONE
    hi DiagnosticVirtualTextInfo ctermbg=6 ctermfg=14 cterm=NONE guibg=#273333 guifg=#66bbbb gui=NONE
    hi DiagnosticVirtualTextHint ctermbg=NONE ctermfg=8 cterm=NONE guibg=NONE guifg=#999999 gui=NONE
    ...
    hi CmpItemAbbr ctermbg=NONE ctermfg=8 cterm=NONE guibg=NONE guifg=#999999 gui=NONE
    hi CmpItemAbbrMatch ctermbg=NONE ctermfg=15 cterm=bold guibg=NONE guifg=#ffffff gui=bold
...
hi link @type.builtin.cpp Identifier
