...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi @text.emphasis ctermbg=NONE ctermfg=15 cterm=italic guibg=NONE guifg=#000000 gui=italic
    hi @text.literal ctermbg=NONE ctermfg=15 cterm=NONE guibg=NONE guifg=#000000 gui=NONE
    hi @text.reference ctermbg=NONE ctermfg=12 cterm=underline guibg=NONE guifg=#447799 gui=underline
    hi @text.strong ctermbg=NONE ctermfg=15 cterm=bold guibg=NONE guifg=#000000 gui=bold
    hi @text.title.1.markdown ctermbg=NONE ctermfg=12 cterm=bold guibg=NONE guifg=#447799 gui=bold
    hi @text.title.2.markdown ctermbg=NONE ctermfg=12 cterm=bold guibg=NONE guifg=#447799 gui=bold
    hi @text.title.3.markdown ctermbg=NONE ctermfg=12 cterm=bold guibg=NONE guifg=#447799 gui=bold
    hi @text.title.4.markdown ctermbg=NONE ctermfg=12 cterm=bold guibg=NONE guifg=#447799 gui=bold
    hi @text.title.5.markdown ctermbg=NONE ctermfg=12 cterm=bold guibg=NONE guifg=#447799 gui=bold
    hi @text.title.6.markdown ctermbg=NONE ctermfg=12 cterm=bold guibg=NONE guifg=#447799 gui=bold
    hi @text.title.1.marker.markdown ctermbg=NONE ctermfg=12 cterm=bold guibg=NONE guifg=#447799 gui=bold
    hi @text.title.2.marker.markdown ctermbg=NONE ctermfg=12 cterm=bold guibg=NONE guifg=#447799 gui=bold
    hi @text.title.3.marker.markdown ctermbg=NONE ctermfg=12 cterm=bold guibg=NONE guifg=#447799 gui=bold
    hi @text.title.4.marker.markdown ctermbg=NONE ctermfg=12 cterm=bold guibg=NONE guifg=#447799 gui=bold
    hi @text.title.5.marker.markdown ctermbg=NONE ctermfg=12 cterm=bold guibg=NONE guifg=#447799 gui=bold
    hi @text.title.6.marker.markdown ctermbg=NONE ctermfg=12 cterm=bold guibg=NONE guifg=#447799 gui=bold
    hi @text.uri ctermbg=NONE ctermfg=15 cterm=underline guibg=NONE guifg=#000000 gui=underline
    hi @type.definition.css ctermbg=NONE ctermfg=15 cterm=NONE guibg=NONE guifg=#000000 gui=NONE
    hi UIBlockRed ctermbg=9 ctermfg=0 cterm=bold guibg=#884444 guifg=#eeeeee gui=bold
    hi UIBlockGreen ctermbg=10 ctermfg=0 cterm=bold guibg=#779966 guifg=#eeeeee gui=bold
    hi UIBlockYellow ctermbg=11 ctermfg=0 cterm=bold guibg=#AA8844 guifg=#eeeeee gui=bold
    hi UIBlockBlue ctermbg=12 ctermfg=0 cterm=bold guibg=#447799 guifg=#eeeeee gui=bold
